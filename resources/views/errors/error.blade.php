...
@section('content')
    <section class="section">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="ghost">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="127.433px" height="132.743px" viewBox="0 0 127.433 132.743" enable-background="new 0 0 127.433 132.743" xml:space="preserve">
                        <path class="body" d="M116.223,125.064c1.032-1.183,1.323-2.73,1.391-3.747V54.76c0,0-4.625-34.875-36.125-44.375
            ...
            s12.625-8.375,12.625-8.375s2.25-3.875,7.25,0.375s7.625,9.75,14.375,8.125C114.739,126.01,115.412,125.902,116.223,125.064z"/>
                                <circle class="eye" cx="86.238" cy="57.885" r="6.667"/>
                                <circle class="eye" cx="40.072" cy="57.885" r="6.667"/>
                                <path class="mouth" d="M71.916,62.782c0.05-1.108-0.809-2.046-1.917-2.095c-0.673-0.03-1.28,0.279-1.667,0.771
            ...
            c-0.007,0.007-0.015,0.014-0.021,0.02C71.666,63.771,71.892,63.307,71.916,62.782z"/>
                                <circle class="sparkle" stroke-miterlimit="10" cx="18.614" cy="99.426" r="3.292"/>
                                <circle class="sparkle" stroke-miterlimit="10" cx="95.364" cy="28.676" r="3.291"/>
                                <circle class="sparkle" stroke-miterlimit="10" cx="24.739" cy="93.551" r="2.667"/>
                                <circle class="sparkle" stroke-miterlimit="10" cx="101.489" cy="33.051" r="2.666"/>
                                <circle class="sparkle" stroke-miterlimit="10" cx="18.738" cy="87.717" r="2.833"/>
                                <path class="outline" stroke-miterlimit="10" d="M116.279,55.814c-0.021-0.286-2.323-28.744-30.221-41.012
            ...
            c7.636,0,15.336,1.684,22.887,5.004c26.766,11.771,29.011,39.047,29.027,39.251V121.405z"/>
                    ...
                    <p class="shadow">
                        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="61px" y="20px" width="122.436px" height="39.744px" viewBox="0 0 122.436 39.744" enable-background="new 0 0 122.436 39.744" xml:space="preserve">
<ellipse cx="61.128" cy="19.872" rx="49.25" ry="8.916"/></svg>
                    </p>
                </div>
            </div>
            <div class="col-md-8">
                <p>
                    I'm sorry but you found a ghost.
                    He's already tamed so you can keep and spend some time with him.
                    It would be very nice if you could give him a new home!?
                    He is very easy to handle, just let him scare some of your visitors and let him see TV.
                    In return you will have the best "Horrorhouse" in your neighborhood.
                </p>
            </div>
        </div>
